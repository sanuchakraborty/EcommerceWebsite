...
const NewProduct = () => {
  ...
  const createProductSubmitHandler = (e) => {
    ...
    myForm.set("imageLink1", imageLink1);
    myForm.set("imageLink2", imageLink2);
    myForm.set("imageLink3", imageLink3);
            ...
            <div className="newProductContainer">
              <form
                ...
                <div id="createProductFormImage">
                  {imageLink1 && <img src={imageLink1} alt="Product Preview" />}
                  {imageLink2 && <img src={imageLink2} alt="Product Preview" />}
                  {imageLink3 && <img src={imageLink3} alt="Product Preview" />}
                </div>
